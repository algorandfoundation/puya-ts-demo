...
describe("MerkleTree", () => {
  ...
  describe("createApplication", () => {
    test("should initialize with empty root hash", () => {
      ...
      expect(merkle.root.value.native).toEqual(expectedRoot);
    });
  });
  ...
  describe("appendLeaf", () => {
    test("should append new leaf with valid proof path", () => {
      ...
      const path = new StaticArray<StaticBytes<33>, 3>(
        new StaticBytes<33>(
          Bytes.fromHex(
  ...
  describe("verify", () => {
    ...
    test("should fail for invalid proof path", () => {
      ...
      const invalidPath = new StaticArray<StaticBytes<33>, 3>(
        new StaticBytes<33>(Bytes(new Uint8Array(33).fill(1))),
        new StaticBytes<33>(Bytes(new Uint8Array(33).fill(1))),
        new StaticBytes<33>(Bytes(new Uint8Array(33).fill(1))),
      );
